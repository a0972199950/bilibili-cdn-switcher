...
| 🦊 **Chrome / Firefox / Edge** | A single `src/` tree; packaging produces a per-browser zip (Edge is Chromium-based and reuses Chrome's manifest as-is) |

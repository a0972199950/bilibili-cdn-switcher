...
- **ID**: huasing-001
- **建立**: 2026-09-11
- **參數**: `utm_source=huasing` · `utm_medium=referral` · `utm_campaign=huasing-post1` · `utm_content=zhcn`
- **Query**: `?utm_source=huasing&utm_medium=referral&utm_campaign=huasing-post1&utm_content=zhcn`
- **貼文**: （待補）
- **備註**: 新加坡華人社區論壇（huasing.net），站方本身用簡體，跟 `sgcn-001`、`xiaohongshu-sg-001` 是同一批新加坡受眾，但獨立開 campaign 分開統計。論壇連結用 `referral`，不要用 `article`
- **狀態**: planned

### TikTok 公司內部分享（簡體中文）
- **ID**: tiktok-internal-zhcn-001
- **建立**: 2026-09-20
- **參數**: `utm_source=tiktok-internal` · `utm_medium=referral` · `utm_campaign=tiktok-internal-post1` · `utm_content=zhcn`
- **Query**: `?utm_source=tiktok-internal&utm_medium=referral&utm_campaign=tiktok-internal-post1&utm_content=zhcn`
- **貼文**: （待補）
- **備註**: ByteDance/TikTok 公司內部分享（如 Lark、內部論壇）。非公開社群貼文，medium 用 `referral` 而非 `social`，source 加 `-internal` 與公開 TikTok 社群帖區分
- **狀態**: planned

### Dcard - 文章
- **ID**: dcard-zhtw-001
- **建立**: 2026-09-20
- **參數**: `utm_source=dcard` · `utm_medium=social` · `utm_campaign=dcard-post1` · `utm_content=zhtw`
- **Query**: `?utm_source=dcard&utm_medium=social&utm_campaign=dcard-post1&utm_content=zhtw`
- **貼文**: （待補）
